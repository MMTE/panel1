...
export function AdminAnalytics() {
  ...
  const analyticsData = {
    ...
    revenueChart: [
      { date: '2024-01-01', revenue: 8500, customers: 45 },
      { date: '2024-01-02', revenue: 9200, customers: 52 },
      { date: '2024-01-03', revenue: 8800, customers: 48 },
      { date: '2024-01-04', revenue: 10500, customers: 61 },
      { date: '2024-01-05', revenue: 11200, customers: 67 },
      { date: '2024-01-06', revenue: 9800, customers: 55 },
      { date: '2024-01-07', revenue: 12100, customers: 72 }
    ],
    topPlans: [
      { name: 'Professional', subscribers: 456, revenue: 45600, growth: 12.5 },
      { name: 'Enterprise', subscribers: 234, revenue: 58500, growth: 8.3 },
      { name: 'Starter', subscribers: 789, revenue: 23670, growth: 15.2 },
      { name: 'Professional Annual', subscribers: 123, revenue: 29520, growth: 6.7 }
    ],
    customerSegments: [
      { segment: 'New Customers', count: 234, percentage: 18.8, revenue: 23400 },
      { segment: 'Returning Customers', count: 567, percentage: 45.5, revenue: 67800 },
      { segment: 'Enterprise Clients', count: 89, percentage: 7.1, revenue: 44500 },
      { segment: 'Trial Users', count: 357, percentage: 28.6, revenue: 0 }
    ],
    recentActivity: [
      {
        type: 'subscription',
        description: 'New Enterprise subscription',
        customer: 'Acme Corp',
        amount: 499.99,
        time: '2 minutes ago'
      },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          <PluginSlot 
            ...
            props={{ user, isDemoMode, data: analyticsData }}
        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="h-64 flex items-end space-x-2">
            {analyticsData.revenueChart.map((item, index) => {
              ...
              const maxValue = Math.max(...analyticsData.revenueChart.map(i => 
      ...
      <PluginSlot 
        ...
        props={{ user, isDemoMode, data: analyticsData, selectedPeriod }}
      ...
      <PluginSlot 
        ...
        props={{ user, isDemoMode, data: analyticsData, selectedPeriod, selectedMetric }}
        className="space-y-6"
      />
    </div>
  );
