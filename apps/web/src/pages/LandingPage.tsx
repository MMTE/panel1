  ...
  const features = [
    {
      ...
      description: "Type-safe database with auto-generated schemas and migrations",
      code: `// Auto-generated Drizzle types
interface User {
  id: string;
  email: string;
  firstName?: string;
...
const user = await db.query.users.findFirst({
  ...
  with: { subscriptions: true }
    ...
    },
    {
      ...
      description: "End-to-end type safety from database to frontend",
      code: `// Backend procedure
...
const { mutate: createUser } = trpc.users.create.useMutation();`
  ...
  const techStack = [
          { name: "PostgreSQL + Drizzle", description: "Type-safe ORM with auto-generated types and migrations", icon: Database, color: "from-blue-500 to-cyan-500" },
